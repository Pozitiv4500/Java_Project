...
@Table(name = "news", indexes = {
        @Index(name = "idx_news_article_id", columnList = "articleId"),
        ...
        @Index(name = "idx_news_duplicate", columnList = "duplicate"),
...
public class News {
    ...
    @Column(name = "coin_mentioned", columnDefinition = "VARCHAR(50)[]")
    ...
    @Column(name = "ai_tag", columnDefinition = "VARCHAR(100)[]")
    ...
    public boolean hasCoinMention(String coin) {
        ...
        return Arrays.asList(coinMentioned).contains(coin.toLowerCase());
    }
    ...
    public boolean hasCategory(String categoryName) {
        ...
        return Arrays.asList(category).contains(categoryName);
    }
    ...
    public String toString() {
        return "News{" +
                ...
                ", pubDate=" + pubDate +
                ", coinMentioned=" + Arrays.toString(coinMentioned) +
                ", sentiment='" + sentiment + '\'' +
                '}';
    }
}
